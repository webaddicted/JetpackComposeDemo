package com.webaddicted.jetpackcomposedemo.utils.di

import android.content.Context
import androidx.room.Room
import com.webaddicted.jetpackcomposedemo.data.db.AppDatabase
import com.webaddicted.jetpackcomposedemo.utils.constant.ApiConstant

object DBModule {

    fun provideYourDatabase(context: Context) =
